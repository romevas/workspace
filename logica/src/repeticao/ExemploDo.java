	...
	public static void main(String[] args) {
		do {
			...
			if (opcao=='+') 
				...
				if (opcao=='-') System.out.println("Subtração : " + (valor1 - valor2));
				else 
					if (opcao=='*') System.out.println("Multiplicação : " + (valor1 * valor2));
					else 
						if (opcao=='/') System.out.println("Divisão : " + (valor1 / valor2));
						else 
